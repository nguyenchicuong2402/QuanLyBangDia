...
public class Values {
    /*========== COLOR ==========*/
    public static final Color COLOR_PRIMARY = Color.decode("#1a237e");
    public static final Color COLOR_SECONDARY = Color.decode("#000051");
    ...
    public static final Color COLOR_DARK = Color.decode("#000051");
